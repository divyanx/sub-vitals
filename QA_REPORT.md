# RedLettuce Visual + Interaction QA Report
...
**Actual**: The tab renders only the inline error banner `Failed to load settings. [Retry]` with no heading. The heading hierarchy jumps from H1 (RedLettuce) directly to nothing.
