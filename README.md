# SubVitals — native Reddit CX analytics
...
│   │   └── studio-bridge/            # Outbound webhook to studio.sub-vitals.app
│   └── shared/
...
**Phase 2 (post-hackathon):** Studio webapp at [studio.sub-vitals.app](https://studio.sub-vitals.app) for multi-sub cross-community analytics, PII guardian, AI-generated content detection, bearer-token REST API for Sprinklr / Khoros integrations.
