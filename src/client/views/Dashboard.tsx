...
function Nav({
  ...
  return (
    <nav className="relative border-b border-[var(--n-4)] bg-[var(--n-0)]">
      <div className="mx-auto flex max-w-full items-stretch px-6">
  ...
  return (
    <div className="space-y-8">
      ...
      {contentBrowserOpen && (
        ...
        >
          <div className="flex h-full w-full max-w-full flex-col overflow-hidden bg-[var(--n-0)]">
...
function CatalogueModal({
  ...
  return (
    ...
    >
      <div className="flex max-h-full w-full max-w-full flex-col overflow-hidden rounded-[var(--r-4)] border border-[var(--n-4)] bg-[var(--n-1)] shadow-[var(--shadow-3)]">
    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="mb-4 max-w-2xl text-sm text-[var(--text-muted)]">
          SubVitals keeps the operational hot data in Devvit Redis. For longer retention, cross-sub
