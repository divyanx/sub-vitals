/**
 * Onboarding.tsx — First-run wizard for RedLattice mods.
 *
...
const STEPS: [Step, Step, Step, Step] = [
  {
    title: 'Welcome to RedLattice',
    icon: '◈',
    body: 'Native CX analytics for your Reddit brand community.',
    detail:
      'RedLattice lives entirely inside your subreddit — no external logins, no third-party cookies. Everything you see is scoped to your installation.',
  },
  {
    title: 'Triage Inbox',
    icon: '⬡',
  ...
  },
  {
    title: "You're ready",
    icon: '✓',
    body: 'Submit a test post to see RedLattice in action.',
    detail:
