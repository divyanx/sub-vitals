/**
 * Curated model catalog for SubVitals.
 *
...
export const CURATED_MODELS: ModelOption[] = [
  ...
  },
  {
    ...
    // approval. Using gpt-5.4-mini as default.
    slug: 'gpt-5.4-mini',
    label: 'GPT-5.4 Mini',
    provider: 'openai',
    tier: 'recommended',
    pricePer1kTaggingCalls: estimateUsd('gpt-5.4-mini'),
    supportsStructuredOutput: true,
  ...
  },
  {
    ...
    provider: 'openai',
    tier: 'best',
    pricePer1kTaggingCalls: estimateUsd('gpt-5.4'),
    supportsStructuredOutput: true,
