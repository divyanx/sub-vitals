# RedLattuce — Devpost Hackathon Submission
...
RedLattuce is a complete, production-quality CX analytics suite built natively on Devvit Web — running entirely inside Reddit with no external app required. It transforms any brand subreddit into a live support intelligence hub the moment it is installed.
