...
**No action needed.** All user-visible branding correctly says "RedLattice". The Devvit slug `redlattuce` in package.json and devvit.json is the registered app name and cannot be changed without invalidating all installations. This is documented in `docs/judges-faq.md`.
