...
2. Ensure the SubVitals dashboard post is pinned (install the app, or use "Open SubVitals dashboard" from the subreddit menu to create + pin it)
...
- [ ] The pinned SubVitals post renders immediately with the Pulse view at `?view=pulse`
...
#### 6. Dashboard shows seeded data after SubVitals processes posts

- [ ] Wait ~30s after seed completes for Devvit triggers to process
- [ ] Open the SubVitals dashboard
