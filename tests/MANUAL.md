...
2. Ensure the RedLettuce dashboard post is pinned (install the app, or use "Open RedLettuce dashboard" from the subreddit menu to create + pin it)
...
- [ ] The pinned RedLettuce post renders immediately with the Pulse view at `?view=pulse`
...
#### 6. Dashboard shows seeded data after RedLettuce processes posts

- [ ] Wait ~30s after seed completes for Devvit triggers to process
- [ ] Open the RedLettuce dashboard
